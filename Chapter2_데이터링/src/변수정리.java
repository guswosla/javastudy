 ...
 *             --
 *             65+1=>66
 *             10+10.5=20.5 자바에서는 항상 같은 데이터현만 연산이 가능
 *             
 *             -->큰 데이터로 변형되서 계산됨 
 *          
 *          논리형 
 ...
 *        
 *        연상처리(결과값은 가장 큰 데이터형이 결과값이다)
 *        byte+int +long=>long
 *        ont+floaty+double=>double
 *        byte+char=> int
 ...
 *  
 *  4) 상수선언 => 변경할 수 없다
 * 	final int ABC = 100=> 상수명은 대문자로 설정된다
...
// sytem.out.println(int)'0'); 
////'0'->48 '1'=>49 'A'=65 'B'=66 'a'=97 'b'=98 
	//yte b1=10;
//byte b2=20;
	//	byte3=(byte)(b1+b2); // 범위값을 넘지 않을 때 형변환가능 
