...
static
{
	...
	public static void main(String[] args) throws Exception {
		...
		//System.out.println("영화 총갯수"+ movieData.length);
		...
		// String name=scan.next();
		 //1990에 개봉한 영화
		 //12세 이상 영화 , startsWith, contains 둘다 됨 
	   ...
	   for(String movie:movieData)
	    	 ...
	    	 if(detail[6].startsWith(String.valueOf(grade)) )//입력한 것 찾아줌 
	    			 {
	    	 System.out.println("순위:"+detail[0] );
	    	 System.out.println("영화명:"+detail[1] );
	    	 System.out.println("장르:"+detail[2] ); 
	    	 System.out.println("출연:"+detail[3] ); 
	    	 System.out.println("개봉일:"+detail[4] ); 
	    	 System.out.println("등급 :"+detail[5] ); 
	    	 System.out.println("감독 :"+detail[6] ); 
	    	 System.out.println("----------------------------------------"); 
