...
public class 문자열_4 {
	...
	public static void main(String[] args) {
		...
		String[] title={
			...
			38,7,7,15,15
			 ...
			 //1.순위가 가장 많이 상승한 노래의 제목과 가수명을 출력하시오
	...
	//	System.out.println("max= "+max );
		...
		for(String t:title)
		    {
		    	if(max<t.length()) // if(s.startsWith(f)로 써도됨)
		    	{
		    		max=t.length();
		...
		System.out.println("하강한 노래는"+count+"개 입니다 ");	
		System.out.println("=======================================");
		// 임영웅의 노래 제목을 출력하시오
		...
		System.out.println("임영웅 노래는 "+count+"개 입니다 ");	
		System.out.println("=======================================");
