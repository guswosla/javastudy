 ...
 *      double d=100
 *               ---------double 변경(100==>100.0)     
 *     DownCasting : 데이터를 작게 만든다 자동은로 안 되고 강제로 바꿔줘야 함
 *      char c=(char)65; c='A'
...
public class 자바연산자 {
   ...
   // 결과 출력  
		...
		System.out.println(avg>=90 && avg<90? "B학점":"");
		System.out.println(avg>=90 && avg<80?"C학점":"" );
		System.out.println(avg>=90 && avg<70? "C학점":"");
		System.out.println(avg>=90 && avg<100? "D학점":"");
