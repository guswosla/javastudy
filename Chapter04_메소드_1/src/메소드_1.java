 ...
 *           trim(), length()
 *           =>메서드는 한가지 기능만 수행하게 만든다
 *           1) 입력
 *           2) 요청 처리 => 기능에 따라 세분화 (여러개의 메소드 제작이가능)
 *           3) 출력
 *           
 *                   
 *                   
 ...
 *      public(기본, 공개)    static : new를 사용하지 않고 자동으로 메소드에 저장
 ...
 *     매개변수 : 사용자의 요청값() => 클릭하거나 입력하는 것은 전부 매개변수
 *              예) 로그인 요청 
 *                 -----------id,pwd 
 *                  아이디 찾기   
 *                 -----------id 
 ...
 *                 -----           ---------------------
 *                 리턴형             매개변수 
 *             =>일반 : 3개 이상이면 묶어서 매개변수 설정
 *                    ---------- 배열, 클래스 
 *    메소드명: 식별자(변수)
 *            = 알파벳이나 한글로 시작한다 (리눅스로 올리면 한글이 다 깨진다)
 *            = 메소드명의 길이 제한은 없다
 *              -----------------------(3~10)
 ...
 *     ------------------------------------
 *              ㅇ           o
 *            =>String(리턴형) replace(chaer c1(매개변수), char c2)   
 *            => 리턴형으로 사용
 *            --------------
 ...
 *     ---------------------------------------
 *              x            x 
 *         System.out.println()=>다음줄에 출력 (거의 빈도가 없다)    
 *     -------------------------------------
 *   
 *  4) 메소드 선언 및 호출 방법 
 *  public class A
