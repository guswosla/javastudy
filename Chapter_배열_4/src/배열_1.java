 ...
 *                    필요시에는 length-1
 *       7.배열의 범위를 초과하면 => ArrayIndexOutBounException
 *        [1]
 *        ---- 인덱스, 첨자 
 *       8. 자동 초기화
 *       -------------new를 이용하면 메모리 항당시에 자동 초기화 
 *       int => 0
 *       double =>0.0
 *       boolean => false
 *       char=> '\u0000'=>null값
 *       모든 클래스는 null값 초기화 
 *       int[] arr;==> arr=null => 침조 변수
 *       => int[] arr={1,2,3,4,5}
 *       => int[] arr=new int[5];
 *               -----0,0,0,0,0 
 *       String s;=> null 
...
public class 배열_1 {
	...
	public static void main(String[] args) {
		...
		// =>1년 1월 1일~ 여청 날자=> 총날수 %7 => 요일 => 1일자에 대한
		//1.전년도까지의 합
		int total=(year-1)*365
				+(year-1)/4
				-(year-1)/100
				+(year-1)/400;// 윤년조건 =>로마시대 윤년 계산법
		//2.전달까지의 합
		int[] lastday= {
			31,2,31,30,31,30,
			31,31,30,31,30,31
